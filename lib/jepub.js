...
var i18n_json_1 = __importDefault(require("src/i18n.json"));
var OEBPS_1 = require("src/templates/OEBPS");
        ...
        if (utils.isEmpty(title)) {
            ...
            if (!Array.isArray(newContent)) {
                this._Images.forEach(function (image) {
                    newContent = newContent.replace("{{ " + image.name + " }}", "<img src=\"" + image.path + "\" alt=\"\"> </img>");
                });
